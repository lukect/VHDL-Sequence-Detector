...
create_clock -add -name sys_clk_pin -period 1000 [get_ports clk]
...
set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS12 } [get_ports { init }]; #IO_L20N_T3_16 Sch=btnc

set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS12 } [get_ports { b1 }]; #IO_L22N_T3_16 Sch=btnd

set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS12 } [get_ports { b2 }]; #IO_L20P_T3_16 Sch=btnl

set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS12 } [get_ports { b3 }]; #IO_L6P_T0_16 Sch=btnr

set_property -dict { PACKAGE_PIN F15 IOSTANDARD LVCMOS12 } [get_ports { b4 }]; #IO_0_16 Sch=btnu
